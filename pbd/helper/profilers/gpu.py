# Source : https://github.com/outerbounds/metaflow-gpu-profile/blob/main/gpu_profile.py
...
def make_plot(
    ...
    with plt.rc_context(
        ...
        _ = ax.plot(tstamps, vals, linewidth=PLOT_LINEWIDTH, color=line_color)
